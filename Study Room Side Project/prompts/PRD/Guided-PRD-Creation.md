...
I am looking to make a study room application with similar functions of discord or slack. The app should allow users to join voice calls, use text channels, join communities or subjects of study, etc. The twist to avoid similarity would be in study techniques. Things like pomodoro timers, active recall, feyman technique, mind mapping, and more should all be native functions of the app. The app should be able to sync things like canvas, google classroom and other commonly used studying/ class tools. Users should be able to create accounts, change usernames, profile pictures, banners, etc. I would also enjoy having a spotify integration where users can join each others jam from the app, or provide recommended playlists for studying. Users can add friends, organizations, schools, etc.
